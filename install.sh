...
sudo pacman -S --noconfirm kitty waybar fish hypridle hyprlock hyprpaper rofi-wayland gammastep brightnessctl pavucontrol pamixer blueberry gnome-tweaks papirus-icon-theme dunst network-manager-applet wl-clipboard fcitx5-config-qt kdeconnect polkit-gnome cliphist noto-fonts-cjk ttf-font-awesome xdg-desktop-portal-gtk xdg-desktop-portal nautilus
paru -S --noconfirm qt5ct-kde qt6ct-kde hyprpicker hyprshot wlogout fcitx5-mozc
